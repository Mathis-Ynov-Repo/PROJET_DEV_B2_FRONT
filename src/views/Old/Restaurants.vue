    ...
    <section class="container-fluid d-flex flex-row filter-sort-container">
      <div class="d-flex p-2 bd-highlight justify-content-center">
        <div class="dropdown">
          ...
          >Trie</a>
          <div
            class="dropdown-menu dropdown-menu-right dropdown-menu-md-left"
...
export default {
  ...
  methods: {
    ...
    async getRestaurants() {
      await Axios.get("http://localhost:8001/api/restaurants").then(
        response => (this.restaurants = response.data)
      );
    },
    async getRestaurantsTypes() {
      await Axios.get("http://localhost:8001/api/restaurants-types").then(
